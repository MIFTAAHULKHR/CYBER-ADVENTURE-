...
class AnimationPlayer:
    def __init__(self):
        ...
        # Anda bisa menambahkan pengecekan di sini untuk setiap key di self.frames
        # apakah hasil import_folder tidak kosong, untuk debugging awal.
        # for key, frame_list in self.frames.items():
        #     if not frame_list:
        #         print(f"[WARNING] AnimationPlayer init: No frames loaded for '{key}'. Path might be incorrect or folder empty.")
