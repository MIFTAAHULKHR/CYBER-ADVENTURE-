...
class Game:
    def __init__(self):
        ...
        try:
            ...
            self.button_start_pressed = pygame.image.load('graphics/button/button_start.png').convert_alpha() #  gambar berbeda untuk pressed
            ...
            self.button_credits_pressed = pygame.image.load('graphics/button/button_credits.png').convert_alpha() #  gambar berbeda
            ...
            self.button_exit_pressed = pygame.image.load('graphics/button/button_exit.png').convert_alpha() #  gambar berbeda
    ...
    def show_credits_screen(self):
        credits_font = pygame.font.Font(UI_FONT, 30) 
        credits_lines = [
            "Credits:",
        ...
        background_credits.fill((30,30,30)) 
        ...
        while active_loop:
            self.screen.blit(background_credits, (0,0)) 

            line_height = 40 
            start_y = (HEIGHT - (len(credits_lines) * line_height)) // 2 - 50 

            for i, line in enumerate(credits_lines):
                credits_text = credits_font.render(line, True, TEXT_COLOR) 
                credits_rect = credits_text.get_rect(center=(WIDTH // 2, start_y + i * line_height))
                self.screen.blit(credits_text, credits_rect)

            pygame.draw.rect(self.screen, UI_BORDER_COLOR, back_button_rect_inflated, border_radius=5)
            pygame.draw.rect(self.screen, UI_BG_COLOR, back_button_rect_inflated.inflate(-6,-6), border_radius=5) 
