...
class Upgrade:
	...
	def create_items(self, surface):
		...
		item_width = surface.get_size()[0] // (self.attribute_nr if self.attribute_nr > 0 else 1) 

		for item_index, _ in enumerate(range(self.attribute_nr)): 
			# horizontal position
